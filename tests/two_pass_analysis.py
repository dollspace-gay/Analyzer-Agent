...
Pass 1: Let LLM analyze freely with all reasoning
Pass 2: Read draft and format into standardized 7-section report

This is more reliable than forcing format during analysis.
"""
